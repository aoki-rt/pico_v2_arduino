...
*/
      ...
      delay(1000);
      g_run.accelerate(HALF_SECTION, g_run.search_speed-25,g_run.search_accel);
      g_run.straight(SECTION-15, g_run.search_speed-25, g_run.max_speed, g_run.search_speed+50,g_run.search_accel);
      g_run.sura(right,g_run.search_speed+50);
      g_run.straight(SECTION-15, g_run.search_speed+50, g_run.max_speed, g_run.search_speed-25,g_run.search_accel);
      g_run.decelerate(HALF_SECTION, g_run.search_speed-25,g_run.search_accel);
      motorDisable();     
      break;
      ...
      delay(1000);
      g_run.accelerate(HALF_SECTION, g_run.search_speed_high-25,g_run.search_accel_high);
      g_run.straight(SECTION-15, g_run.search_speed_high-25, g_run.max_speed, g_run.search_speed_high+50,g_run.search_accel_high);
      g_run.sura(right,g_run.search_speed_high+50);
      g_run.straight(SECTION-15, g_run.search_speed_high+50, g_run.max_speed, g_run.search_speed_high-25,g_run.search_accel_high);
      g_run.decelerate(HALF_SECTION, g_run.search_speed_high-25,g_run.search_accel_high);
      motorDisable();     
      break;      
    default:
