...
void MISC::modeExec(int mode)
{
  ...
  switch (mode) {
    ...
    case 10:
      mapCopy();
      g_map.positionInit();
      g_fast.runPatternSura(g_map.goal_mx, g_map.goal_my, g_run.search_accel, g_run.search_speed - 25);
      g_run.rotate(right, 2);
      g_map.nextDir(right);
      g_map.nextDir(right);
      g_misc.goalAppeal();
    ...
    case 11:
      mapCopy();
      g_map.positionInit();
      g_fast.runPatternSura(g_map.goal_mx, g_map.goal_my, g_run.search_accel_high, g_run.search_speed_high - 25);
      g_run.rotate(right, 2);
      g_map.nextDir(right);
      g_map.nextDir(right);
      g_misc.goalAppeal();
